...
## Project Structure
    ...
    ├── testapiautostorybo_110080  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_110080`
...
2. Clone this repo and `cd testapiautostorybo_110080`
